...
sealed class Prototypes{
    ...
    data class JsVideoDict(val id: String, val user: String,
                           val dateStart: String, val dateEnd: String)
    data class JsFrameDict(val id: String, val user: String, val date: String,
    ...
    // Database prototypes
    data class DbUploadMenu(val videoName: String, val startDate: String, val currentStatus: String,
                            val progress: Int)
    data class DbCheckVideoToUpload(val videoName: String, val startDate: String,
    ...
    data class RfParametersToUpload(val user: String, val videoId: String, val startDate: String,
